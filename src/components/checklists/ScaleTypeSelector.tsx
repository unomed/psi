...
export function ScaleTypeSelector({ form, name, value, onValueChange, onChange }: ScaleTypeSelectorProps) {
  const handleChange = (newValue: ScaleType) => {
  ...
  // Standalone version without form
  return (
    <div>
