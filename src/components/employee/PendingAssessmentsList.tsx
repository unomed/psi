...
export function PendingAssessmentsList({ employeeId, highlightAssessmentId }: PendingAssessmentsListProps) {
  ...
  console.log('[PendingAssessmentsList] Iniciando componente com employeeId:', employeeId);
  console.log('[PendingAssessmentsList] Estado de carregamento:', loading);
  console.log('[PendingAssessmentsList] Erro:', error);
  console.log('[PendingAssessmentsList] Avaliações carregadas:', assessments);
          ...
          <CardContent className="p-4">
            <div className="flex items-start justify-between">
              ...
              <Button 
                ...
                variant="outline"
                onClick={() => {
                  console.log('[PendingAssessmentsList] Abrindo avaliação:', assessment.id);
