...
export function useUserRole() {
  ...
  if (typeof useState === 'undefined' || typeof useRef === 'undefined' || typeof useCallback === 'undefined') {
  ...
  // Additional safety check for React context
  try {
    ...
    console.error('[useUserRole] Critical error in hook initialization:', error);
    return {
      userRole: null,
      userCompanies: [],
      roleLoading: false,
