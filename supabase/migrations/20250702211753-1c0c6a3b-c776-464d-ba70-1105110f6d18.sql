-- FASE 2: Configurações Psicossociais - Criar tabelas para sistema de análise de risco (corrigido sem is_active)
...
CREATE INDEX IF NOT EXISTS idx_psychosocial_category_weights_company 
ON psychosocial_category_weights(company_id);
