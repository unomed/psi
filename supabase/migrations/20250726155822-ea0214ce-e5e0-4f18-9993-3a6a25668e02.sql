-- Create a simplified authenticate_employee function that doesn't rely on pgcrypto initially
-- This is a temporary solution until pgcrypto is properly enabled
